...
import click
from creds import ROUTER_PASSWORD, ROUTER_USERNAME, SECRET
from netmiko import ConnectHandler

@click.command()
@click.option('--source', help="VLAN you wish to change")
@click.option('--target', help="VLAN you are changing to")
@click.option('--name', help="Name for your new target VLAN")
@click.option('--switch', help="Switch you are making the changes on")
